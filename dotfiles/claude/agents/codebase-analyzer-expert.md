---
name: codebase-analyzer-expert
description: Analyzes codebase implementation details. Call the codebase-analyzer-expert agent when you need to find detailed information about specific components. As always, the more detailed your request prompt, the better! :)
